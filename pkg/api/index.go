...
func getProfileNode(c *models.ReqContext) *dtos.NavLink {
	...
	children := []*dtos.NavLink{
		{
			Text: "偏爱", Id: "profile-settings", Url: setting.AppSubUrl + "/profile", Icon: "sliders-v-alt",
		},
		{
...
func (hs *HTTPServer) getNavTree(c *models.ReqContext, hasEditPerm bool) ([]*dtos.NavLink, error) {
	...
	if hasEditPerm {
		...
		if c.OrgRole == models.ROLE_ADMIN || c.OrgRole == models.ROLE_EDITOR {
			children = append(children, &dtos.NavLink{
				Text: "文件夹", SubTitle: "Create a new folder to organize your dashboards", Id: "folder",
				Icon: "folder-plus", Url: setting.AppSubUrl + "/dashboards/folder/new",
			})
		}
		children = append(children, &dtos.NavLink{
			Text: "导入", SubTitle: "Import dashboard from file or Grafana.com", Id: "import", Icon: "import",
	...
	if c.IsGrafanaAdmin {
		adminNavLinks := []*dtos.NavLink{
			...
			{Text: "团队", Id: "global-orgs", Url: setting.AppSubUrl + "/admin/orgs", Icon: "building"},
